    ...
    return (
        ...
        >
            ...
            <div className="p-5 text-center h-28 flex flex-col justify-center bg-white relative">
                ...
                <div className={`absolute inset-0 flex items-center justify-center p-5 transition-all duration-300 group-hover:opacity-100 group-hover:visible ${isTouched ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
