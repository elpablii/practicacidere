...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        {
            name: "Instagram",
            href: "https://www.instagram.com/cidere_regiondecoquimbo/",
        ...
        {
            name: "X (Twitter)",
            href: "https://x.com/cidereivregion",
            icon: <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.292 19.49h2.039L6.486 3.24H4.298l13.311 17.403z" /></svg>
        },
        {
            name: "LinkedIn",
            href: "https://www.linkedin.com/in/cidere-regi%C3%B3n-de-coquimbo-43b602205/",
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="order-4 lg:order-2 lg:pl-8">
                            ...
                            <ul className="space-y-4 text-sm text-gray-200">
                                ...
                                <li><Link href="https://www.sofofa.cl/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-secondary transition-colors cursor-pointer hover:translate-x-1 duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14]"><span className="text-secondary mr-2">›</span>SOFOFA</Link></li>
                                <li><Link href="https://www.gorecoquimbo.cl/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-secondary transition-colors cursor-pointer hover:translate-x-1 duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14]"><span className="text-secondary mr-2">›</span>GORE Coquimbo</Link></li>
                                <li><Link href="https://espacioindustria.cl/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-secondary transition-colors cursor-pointer hover:translate-x-1 duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14]"><span className="text-secondary mr-2">›</span>Espacio Industrial Minero</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="order-3 lg:order-3 lg:pl-4">
                            ...
                            <ul className="space-y-4 text-sm text-gray-200" aria-label="Información de contacto">
                                <li className="flex items-start focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14] rounded-md" tabIndex={0}>
                                    ...
                                    <span><span className="sr-only">Dirección: </span>{contactInfo.address}</span>
                                </li>
                                <li className="flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14] rounded-md" tabIndex={0}>
                                    <span className="text-secondary mr-3" aria-hidden="true">📞</span>
                                    <span><span className="sr-only">Teléfono: </span>{contactInfo.phone1}</span>
                                </li>
                                <li className="flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14] rounded-md" tabIndex={0}>
                                    <svg aria-hidden="true" className="w-5 h-5 text-secondary mr-3" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L0 24l6.335-1.662c1.72.94 3.659 1.437 5.63 1.438h.004c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" /></svg>
                                    <span><span className="sr-only">WhatsApp: </span>{contactInfo.phone2}</span>
                                </li>
                                <li className="flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14] rounded-md" tabIndex={0}>
                                    <span className="text-secondary mr-3" aria-hidden="true">✉️</span>
                                    <span><span className="sr-only">Correo electrónico: </span>{contactInfo.email}</span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                {socialLinks.map((social) => (
                                    <Link
                                        ...
                                        className="w-10 h-10 rounded-full bg-white/10 text-white flex items-center justify-center hover:bg-secondary hover:text-white transition-all shadow-md transform hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#0b1b36]"
