...
export default function NosotrosPage() {
    return (
        <main className="min-h-screen bg-transparent overflow-x-hidden">
            <PageHeaderAnimator id="mision" bgImage="/images/slider/tercer-banner-pagina-inicio-socios.webp" className="bg-primary pt-40 pb-28 px-6 text-center relative overflow-hidden">
