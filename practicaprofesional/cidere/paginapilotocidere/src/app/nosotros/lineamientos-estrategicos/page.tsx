...
export default function NosotrosPage() {
    return (
        <main className="min-h-screen bg-transparent overflow-x-hidden">
            <PageHeaderAnimator id="mision" bgImage="/images/fotos-banners-y-tarjetas/tercer-banner-pagina-inicio-socios.webp" className="bg-primary pt-40 pb-28 px-6 text-center relative overflow-hidden">
