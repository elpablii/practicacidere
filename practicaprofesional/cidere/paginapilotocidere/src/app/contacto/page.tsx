...
export default function ContactPage() {
    return (
        <main className="min-h-screen bg-transparent">
            ...
            <PageHeaderAnimator bgImage="/images/fotos-banners-y-tarjetas/Avenida-del-Mar-La-Serena.webp" className="relative w-full h-[40vh] md:h-[50vh] overflow-hidden bg-primary">
