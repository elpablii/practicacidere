                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="lg:pl-4">
                            ...
                            <ul className="space-y-4 text-sm text-gray-200" aria-label="Información de contacto">
                                ...
                                <li className="flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14] rounded-md" tabIndex={0}>
                                    <span className="text-secondary mr-3" aria-hidden="true">📞</span>
                                    <span><span className="sr-only">Teléfono alternativo: </span>{contactInfo.phone2}</span>
                                </li>
                                <li className="flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b14] rounded-md" tabIndex={0}>
